...
def should_do_markup() -> bool:
    ...
    # https://xkcd.com/927/
    for v in ["PY_COLORS", "CLICOLOR", "FORCE_COLOR", "DISTRONODE_FORCE_COLOR"]:
...
# Define DISTRONODE_FORCE_COLOR if markup is enabled and another value is not
# already given. This assures that Distronode subprocesses are still colored,
# even if they do not run with a real TTY.
if should_do_markup():
    os.environ["DISTRONODE_FORCE_COLOR"] = os.environ.get("DISTRONODE_FORCE_COLOR", "1")
