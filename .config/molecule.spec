...
Release:        1%{?dist}
Summary:        Molecule testing framework for Distronode content

License:        MIT
URL:            https://github.com/distronode/molecule
Source0:        %{pypi_source}
...
%changelog
Available at https://github.com/distronode/molecule/releases
